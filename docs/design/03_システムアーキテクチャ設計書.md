...
| カテゴリ | 技術 | バージョン | 選定理由 |
|----------|------|------------|----------|
| フレームワーク | Next.js | 14+ | SSR/SSG、最適化 |
| 言語 | TypeScript | 5.0+ | 型安全性 |
| 状態管理 | Zustand | 4.4+ | シンプル、軽量 |
| UIライブラリ | Tailwind CSS | 3.3+ | ユーティリティファースト |
