...
PROJECT_DIR="${HOME}/claude-code-cluster"
...
cd "${HOME}/ITDO_ERP2" 2>/dev/null || cd "${HOME}/claude-code-cluster" 2>/dev/null || cd /home/*/ITDO_ERP2 2>/dev/null || {
...
echo "  https://github.com/ootakazuhiko/claude-code-cluster/tree/${LOG_BRANCH}/${LOG_DIR}"
echo ""
