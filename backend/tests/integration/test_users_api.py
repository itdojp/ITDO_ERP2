...
class TestUsersAPI:
    ...
    def test_create_user_as_admin(self, client: TestClient, admin_token: str, db_session: Session) -> None:
    ...
    def test_create_user_duplicate_email(self, client: TestClient, admin_token: str, test_user: User) -> None:
    ...
    def test_create_user_as_regular_user(self, client: TestClient, user_token: str) -> None:
    ...
    def test_create_user_with_is_active_false(self, client: TestClient, admin_token: str) -> None:
    ...
    def test_create_user_invalid_email(self, client: TestClient, admin_token: str, email: str) -> None:
