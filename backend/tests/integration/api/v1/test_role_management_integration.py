...
class TestRoleManagementIntegration:
    ...
    async def test_complete_role_management_workflow(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            with pytest.mock.patch(
                "app.api.v1.roles.get_current_active_user", return_value=admin_user
            ):
            ...
            with pytest.mock.patch(
                ...
                perm_response = await client.put(
                    f"/api/v1/roles/{role_id}/permissions", json=permission_codes
                )
            ...
            with pytest.mock.patch(
                ...
                user_roles_response = await client.get(
                    f"/api/v1/roles/user/{regular_user.id}"
                )
            ...
            with pytest.mock.patch(
                ...
                permissions_response = await client.get(
                    f"/api/v1/roles/user/{regular_user.id}/permissions"
                )
            ...
            with pytest.mock.patch(
                ...
                update_response = await client.put(
                    f"/api/v1/roles/{role_id}", json=update_data
                )
            ...
            with pytest.mock.patch(
                ...
                remove_response = await client.delete(
                    f"/api/v1/roles/assign/{regular_user.id}/{role_id}"
                )
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            with pytest.mock.patch(
                ...
                parent_response = await client.post(
                    "/api/v1/roles/", json=parent_role_data
                )
            ...
            with pytest.mock.patch(
                ...
                child_response = await client.post(
                    "/api/v1/roles/", json=child_role_data
                )
            ...
            with pytest.mock.patch(
                ...
                tree_response = await client.get(
                    f"/api/v1/roles/organization/{org.id}/tree"
                )
    ...
    async def test_permission_validation_and_security(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            with pytest.mock.patch(
                "app.api.v1.roles.get_current_active_user", return_value=superuser
            ):
            ...
            with pytest.mock.patch(
                "app.api.v1.roles.get_current_active_user", return_value=regular_user
            ):
                response = await client.post("/api/v1/roles/", json=role_data)
            ...
            with pytest.mock.patch(
                ...
                perm_response = await client.put(
                    "/api/v1/roles/1/permissions", json=invalid_permissions
                )
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            with pytest.mock.patch(
                ...
                response = await client.get(
                    f"/api/v1/roles/user/{test_user.id}/permissions"
                )
