    ...
    async def test_complete_organization_hierarchy_workflow(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            tree_response = await client.get(
                f"/api/v1/organizations/{root_org.id}/tree"
            )
            ...
            stats_response = await client.get(
                f"/api/v1/organizations/{root_org.id}/stats"
            )
            ...
            dept_tree_response = await client.get(
                f"/api/v1/departments/{dept1.id}/tree"
            )
            ...
            dept_users_response = await client.get(
                f"/api/v1/user-assignments/departments/{dept1.id}/users"
            )
    ...
    async def test_hierarchy_validation_and_constraints(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            validation_response = await client.get(
                f"/api/v1/organizations/{org1.id}/validation"
            )
    ...
    async def test_user_assignment_workflow(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            assign_response = await client.post(
                "/api/v1/user-assignments/assign", json=assignment_data
            )
            ...
            # Verify assignment
            user_assignments_response = await client.get(
                f"/api/v1/user-assignments/users/{user.id}/assignments"
            )
    ...
    async def test_data_consistency_after_operations(self, db: AsyncSession):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            move_response = await client.post(
                f"/api/v1/departments/{dept2.id}/move", params={"new_parent_id": None}
            )
            ...
            validation_response = await client.get(
                f"/api/v1/departments/{dept1.id}/validation"
            )
            assert validation_response.status_code == 200
            validation_data = validation_response.json()
