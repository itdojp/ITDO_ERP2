...
class TestTaskAPI:
    ...
    def test_create_task_validation_error(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
    ...
    def test_get_tasks_no_filter(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
        """Test IT-API-004: GET /tasks - フィルタなし"""
        raise NotImplementedError("TDD Red: Test not implemented")

    def test_get_tasks_with_filter(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
        """Test IT-API-005: GET /tasks - フィルタあり"""
        raise NotImplementedError("TDD Red: Test not implemented")

    def test_get_task_exists(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
    ...
    def test_update_task_success(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
        """Test IT-API-008: PATCH /tasks/{id} - 正常系"""
        raise NotImplementedError("TDD Red: Test not implemented")

    def test_update_task_optimistic_lock(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
        """Test IT-API-009: PATCH /tasks/{id} - 楽観的ロック"""
        raise NotImplementedError("TDD Red: Test not implemented")

    def test_delete_task_success(self, client: TestClient, auth_headers: Dict[str, str]) -> None:
