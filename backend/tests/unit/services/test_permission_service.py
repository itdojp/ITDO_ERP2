...
class TestPermissionService:
    ...
    def test_check_user_permissions(
        ...
        result = permission_service.check_user_permissions(
            user.id,
            granted_codes + not_granted_codes
        )
    ...
    def test_user_has_permission(
        ...
        assert permission_service.user_has_permission(user.id, not_granted_code) is False
    ...
    def test_list_permission_templates_filtered(
        ...
        inactive_templates = permission_service.list_permission_templates(is_active=False)
