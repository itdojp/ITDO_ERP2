...
class TestProductsV54Simple:
    ...
    def setup_clean_state(self):
        ...
        from app.api.v1.products_v54_simple import categories_db, products_db
    ...
    def test_create_category(self, client: TestClient):
        ...
        category_data = {"name": "Electronics", "description": "Electronic products"}
    ...
    def test_create_product_with_category(self, client: TestClient):
        ...
        category_response = client.post(
            "/api/v1/products-v54/categories/", json={"name": "Electronics"}
        )
    ...
    def test_create_product_duplicate_sku(self, client: TestClient):
        ...
        product_data = {"name": "Product 1", "price": 100.0, "sku": "DUPLICATE"}
    ...
    def test_list_products_with_filtering(self, client: TestClient):
        ...
        response = client.get(
            f"/api/v1/products-v54/products/?category_id={category_id}"
        )
        assert response.status_code == 200
    ...
    def test_get_product(self, client: TestClient):
        ...
        create_response = client.post(
            "/api/v1/products-v54/products/", json=product_data
        )
    ...
    def test_update_product(self, client: TestClient):
        ...
        response = client.put(
            f"/api/v1/products-v54/products/{product_id}", json=update_data
        )
        assert response.status_code == 200
    ...
    def test_update_product_not_found(self, client: TestClient):
        ...
        response = client.put(
            "/api/v1/products-v54/products/invalid-id", json=update_data
        )
        assert response.status_code == 404
        assert "Product not found" in response.json()["detail"]
    ...
    def test_get_product_stats(self, client: TestClient):
        ...
        # Create category
        client.post("/api/v1/products-v54/categories/", json={"name": "Test Category"})
    ...
    def test_performance_requirement(self, client: TestClient):
        ...
        response = client.post(
            "/api/v1/products-v54/products/",
            json={"name": "Performance Test", "price": 100.0},
        )
        end_time = time.time()
        ...
        assert execution_time_ms < 500, (
            f"Product creation took {execution_time_ms:.2f}ms"
        )
        ...
        execution_time_ms = (end_time - start_time) * 1000
        assert execution_time_ms < 500, (
            f"Product listing took {execution_time_ms:.2f}ms"
        )
