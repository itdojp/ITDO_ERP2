"""Advanced tests for ReportFrequency model."""
...
from app.models.analytics import ReportFrequency


class TestReportFrequency:
    """Comprehensive tests for ReportFrequency model."""

    def test_model_creation(self, db_session):
        """Test basic model creation."""
        instance = ReportFrequency()
