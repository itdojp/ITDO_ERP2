...
class TestCustomersAPI:
    ...
    def test_get__customer_id_success(self):
        ...
        # Make request
        response = self.client.get(
            "/{customer_id}", json=test_data, headers=self.headers
        )
    ...
    def test_get__customer_id_validation_error(self):
        ...
        response = self.client.get(
            "/{customer_id}", json=invalid_data, headers=self.headers
        )
    ...
    def test_put__customer_id_assign_sales_rep_success(self):
        ...
        # Make request
        response = self.client.put(
            "/{customer_id}/assign-sales-rep", json=test_data, headers=self.headers
        )
    ...
    def test_put__customer_id_assign_sales_rep_validation_error(self):
        ...
        response = self.client.put(
            "/{customer_id}/assign-sales-rep", json=invalid_data, headers=self.headers
        )
    ...
    def test_get__customer_id_sales_summary_success(self):
        ...
        # Make request
        response = self.client.get(
            "/{customer_id}/sales-summary", json=test_data, headers=self.headers
        )
    ...
    def test_get__customer_id_sales_summary_validation_error(self):
        ...
        response = self.client.get(
            "/{customer_id}/sales-summary", json=invalid_data, headers=self.headers
        )
