...
class TestProductManagement:
    ...
    async def test_create_product_category(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_category') as mock_create:
            ...
            response = await async_client.post("/api/v1/products/categories", json=category_data)
    ...
    async def test_create_brand(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_brand') as mock_create:
            mock_create.return_value = Mock(
                id=uuid.uuid4(),
                name="Apple",
                slug="apple",
            ...
            response = await async_client.post("/api/v1/products/brands", json=brand_data)
            assert response.status_code == 200
    ...
    async def test_create_product(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_product') as mock_create:
            mock_create.return_value = Mock(
                id=uuid.uuid4(),
                sku="IPHONE-13-PRO",
                name="iPhone 13 Pro",
    ...
    async def test_search_products(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.search_products') as mock_search:
            ...
            response = await async_client.get("/api/v1/products/search", params=search_params)
            assert response.status_code == 200
    ...
    async def test_update_inventory(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.update_inventory') as mock_update:
...
class TestIntegrationScenarios:
    ...
    async def test_complete_product_workflow(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_category') as mock_create_cat:
            mock_category = Mock(id=uuid.uuid4(), name="Smartphones", slug="smartphones")
            mock_create_cat.return_value = mock_category
            
            cat_response = await async_client.post("/api/v1/products/categories", json=category_data)
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_brand') as mock_create_brand:
            mock_brand = Mock(id=uuid.uuid4(), name="Apple", slug="apple")
            mock_create_brand.return_value = mock_brand
            
            brand_response = await async_client.post("/api/v1/products/brands", json=brand_data)
        ...
        with patch('app.api.v1.product_management_v66.ProductManagementService.create_product') as mock_create_prod:
            mock_product = Mock(
                id=uuid.uuid4(),
                sku="IPHONE-14-PRO",
                name="iPhone 14 Pro",
            ...
            prod_response = await async_client.post("/api/v1/products/", json=product_data)
    ...
    async def test_pricing_with_discounts_workflow(self, async_client, mock_db):
        ...
        with patch('app.api.v1.product_pricing_v66.Discount') as mock_discount_model:
            ...
            discount_response = await async_client.post("/api/v1/pricing/discounts", json=discount_data)
        ...
        with patch('app.api.v1.product_pricing_v66.PricingEngine.calculate_product_price') as mock_calc:
            mock_calc.return_value = Mock(
                product_id=uuid.uuid4(),
                base_price=Decimal("100.00"),
                ...
                applied_discounts=[{"type": "coupon", "name": "10% Off Everything", "discount_amount": 10.0}]
            )
            
            price_response = await async_client.post("/api/v1/pricing/calculate", json=price_request)
...
class TestPerformance:
    ...
    async def test_search_performance(self, async_client):
        ...
        with patch('app.api.v1.product_search_v66.ElasticsearchService.search_products') as mock_search:
            mock_search.return_value = Mock(
                total=100,
                products=[{"id": str(uuid.uuid4()), "name": f"Product {i}"} for i in range(20)],
    ...
    async def test_bulk_operations_performance(self, async_client):
        ...
        with patch('app.api.v1.product_pricing_v66.PricingEngine.calculate_bulk_pricing') as mock_bulk:
            ...
            response = await async_client.post("/api/v1/pricing/calculate-bulk", json=items)
            assert response.status_code == 200
