...
from app.api.v1.inventory_management_v67 import (
    InventoryManagementService, MovementType, LocationType, InventoryStatus
)
...
class TestInventoryLocationManagement:
    ...
    async def test_create_warehouse_location(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.create_location') as mock_create:
            ...
            response = await async_client.post("/api/v1/inventory/locations", json=location_data)
    ...
    async def test_create_hierarchical_locations(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.create_location') as mock_create:
            ...
            parent_response = await async_client.post("/api/v1/inventory/locations", json=parent_location_data)
            ...
            child_response = await async_client.post("/api/v1/inventory/locations", json=child_location_data)
    ...
    async def test_get_locations_with_filters(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.get_locations') as mock_get:
...
class TestInventoryBalanceManagement:
    ...
    async def test_get_inventory_balances(self, inventory_service):
        ...
        with patch.object(inventory_service.db, 'execute') as mock_execute:
            ...
            mock_execute.return_value.scalars.return_value.all.return_value = [mock_balance]
            
            balances = await inventory_service.get_inventory_balance(
                product_id=mock_balance.product_id,
                location_id=mock_balance.location_id
            )
    ...
    async def test_weighted_average_cost_calculation(self, inventory_service):
        ...
        with patch.object(inventory_service.db, 'execute') as mock_execute:
            ...
            expected_avg_cost = (Decimal("100") * Decimal("20") + Decimal("50") * Decimal("30")) / Decimal("150")
...
class TestStockTransfers:
    ...
    async def test_create_stock_transfer(self, inventory_service):
        ...
        with patch.object(inventory_service.db, 'execute') as mock_execute:
            ...
            # Setup mock returns
            mock_execute.return_value.scalars.return_value.all.return_value = [from_location, to_location]
            mock_execute.return_value.scalar_one_or_none.return_value = from_balance
            
            inventory_service.redis.incr = AsyncMock(return_value=1)
            inventory_service.redis.expire = AsyncMock()
            
            with patch.object(inventory_service, 'update_inventory_balance') as mock_update:
    ...
    async def test_create_stock_adjustment(self, inventory_service):
        ...
        with patch.object(inventory_service.db, 'execute') as mock_execute:
            ...
            with patch.object(inventory_service, 'update_inventory_balance') as mock_update:
                ...
                adjustment = await inventory_service.create_stock_adjustment(adjustment_data)
...
class TestDemandForecasting:
    ...
    async def test_generate_demand_forecast_complete(self, inventory_service):
        ...
        with patch.object(inventory_service, '_get_historical_demand') as mock_hist:
            ...
            with patch.object(inventory_service.db, 'add') and patch.object(inventory_service.db, 'commit'):
                forecast_response = await inventory_service.generate_demand_forecast(request)
    ...
    async def test_low_stock_alert_generation(self, inventory_service):
        ...
        with patch.object(inventory_service.db, 'execute') as mock_execute:
            ...
            with patch.object(inventory_service.db, 'add') as mock_add:
                ...
                alert_calls = [call for call in call_args if 'InventoryAlert' in str(call)]
    ...
    async def test_get_inventory_alerts_endpoint(self, async_client, mock_db):
        ...
        with patch('app.api.v1.inventory_management_v67.select') as mock_select:
            ...
            with patch.object(mock_db, 'execute') as mock_execute:
                mock_execute.return_value.scalars.return_value.all.return_value = [mock_alert]
...
class TestIntegrationScenarios:
    ...
    async def test_complete_inventory_workflow(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.create_location') as mock_create_loc:
            location_id = uuid.uuid4()
            ...
            loc_response = await async_client.post("/api/v1/inventory/locations", json=location_data)
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.update_inventory_balance') as mock_update:
            ...
            with patch.object(mock_db, 'execute') as mock_execute:
                ...
                movement_response = await async_client.post("/api/v1/inventory/movements", json=movement_data)
                assert movement_response.status_code == 200
        
        # 3. Check inventory balance
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.get_inventory_balance') as mock_get_bal:
    ...
    async def test_stock_transfer_workflow(self, async_client, mock_db, mock_redis):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.create_stock_transfer') as mock_transfer:
...
class TestPerformanceAndScalability:
    ...
    async def test_bulk_inventory_operations(self, async_client):
        ...
        with patch('app.api.v1.inventory_management_v67.InventoryManagementService.get_inventory_balance') as mock_get:
            ...
            with patch('app.api.v1.inventory_management_v67.InventoryManagementService.update_inventory_balance') as mock_update:
                ...
                with patch('app.core.database.get_db') as mock_db:
                    with patch.object(mock_db, 'execute') as mock_execute:
                        ...
                        task = async_client.post("/api/v1/inventory/movements", json=movement_data)
