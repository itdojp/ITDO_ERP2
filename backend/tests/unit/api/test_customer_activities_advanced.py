...
class TestCustomerActivitiesAPI:
    ...
    def test_get__activity_id_success(self):
        ...
        # Make request
        response = self.client.get(
            "/{activity_id}", json=test_data, headers=self.headers
        )
    ...
    def test_get__activity_id_validation_error(self):
        ...
        response = self.client.get(
            "/{activity_id}", json=invalid_data, headers=self.headers
        )
    ...
    def test_get__reports_activity_summary_success(self):
        ...
        # Make request
        response = self.client.get(
            "/reports/activity-summary", json=test_data, headers=self.headers
        )
    ...
    def test_get__reports_activity_summary_validation_error(self):
        ...
        response = self.client.get(
            "/reports/activity-summary", json=invalid_data, headers=self.headers
        )
    ...
    def test_get__upcoming_next_actions_success(self):
        ...
        # Make request
        response = self.client.get(
            "/upcoming/next-actions", json=test_data, headers=self.headers
        )
    ...
    def test_get__upcoming_next_actions_validation_error(self):
        ...
        response = self.client.get(
            "/upcoming/next-actions", json=invalid_data, headers=self.headers
        )
    ...
    def test_put__activity_id_complete_success(self):
        ...
        # Make request
        response = self.client.put(
            "/{activity_id}/complete", json=test_data, headers=self.headers
        )
    ...
    def test_put__activity_id_complete_validation_error(self):
        ...
        response = self.client.put(
            "/{activity_id}/complete", json=invalid_data, headers=self.headers
        )
