...
def setup_sync_test_data():
    ...
    # Clear core inventory data
    try:
        from app.api.v1.endpoints.inventory_core import (
            locations_store, inventory_items_store, movements_store, 
            adjustments_store, transfers_store
        )
