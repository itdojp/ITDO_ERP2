"""
E2E tests for api_consumer_journey
API consumer authentication and usage
...
class TestApiConsumerJourneyE2E:
    """E2E test class for api_consumer_journey"""
    
    @pytest.mark.asyncio
    async def test_complete_journey_success(self, async_client):
        """Test complete API consumer authentication and usage - success path"""
        # Step 1: get_api_key
    ...
    async def test_journey_with_errors(self, async_client):
        """Test API consumer authentication and usage with error scenarios"""
        # Test error handling throughout the journey
        pass
    
    @pytest.mark.asyncio
    async def test_journey_performance(self, async_client):
        """Test API consumer authentication and usage performance"""
        import time
    ...
    async def test_journey_concurrent_users(self, async_client):
        """Test API consumer authentication and usage with concurrent users"""
