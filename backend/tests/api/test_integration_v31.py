    ...
    def test_bulk_execute_connectors_success(self, mock_bulk_execute):
        ...
        mock_bulk_execute.return_value = {
            ...
            "execution_results": [
                ...
                {"connector_id": "conn-3", "status": "failed", "error": "Connection timeout"}
            ],
            "errors": [
                {"connector_id": "conn-3", "error": "Connection timeout"}
            ],
            "started_at": datetime.now(),
            "completed_at": datetime.now(),
    ...
    def test_bulk_health_check_success(self, mock_bulk_health):
        ...
        mock_bulk_health.return_value = {
            ...
            "results": [
                ...
                {"system_id": "sys-3", "status": "unhealthy", "error": "Connection refused"}
            ],
            "checked_at": datetime.now().isoformat()
        }
