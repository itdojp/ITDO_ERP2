...
from app.schemas.sales_complete_v30 import (
    CustomerCreate, CustomerUpdate, SalesOrderCreate, SalesOrderItemCreate,
    QuoteCreate, QuoteItemCreate, PaymentCreate, ShipmentCreate, ShipmentItemCreate
)
...
class TestCustomerAPI:
    def test_create_customer(self, mock_db, mock_current_user):
        ...
        with patch("app.api.v1.sales_complete_v30.get_db", return_value=mock_db), \
             patch("app.api.v1.sales_complete_v30.get_current_user", return_value=mock_current_user), \
...
class TestQuoteAPI:
    def test_create_quote(self, mock_db, mock_current_user):
        ...
        with patch("app.api.v1.sales_complete_v30.get_db", return_value=mock_db), \
            ...
            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(quote_data, mock_current_user["sub"])
...
class TestAnalyticsAPI:
    ...
    def test_get_sales_stats(self, mock_db, mock_current_user):
        ...
        with patch("app.api.v1.sales_complete_v30.get_db", return_value=mock_db), \
            ...
            mock_db.query.return_value.group_by.return_value.all.return_value = [("confirmed", 50), ("shipped", 30)]
