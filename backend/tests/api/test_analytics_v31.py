...
class TestPredictionAPI:
    ...
    def test_get_prediction_forecast_success(self, mock_forecast):
        ...
        mock_forecast.return_value = {
            ...
            "forecast_data": [
                {"date": "2024-02-01", "predicted_value": 87500, "confidence_interval": [82000, 93000]},
                {"date": "2024-02-02", "predicted_value": 88200, "confidence_interval": [82800, 93600]}
            ],
            "model_accuracy": 0.92,
            "generated_at": datetime.now().isoformat()
        }
...
class TestIntegration:
    ...
    def test_complete_analytics_workflow(self, mock_service, sample_data_source_data, sample_metric_data):
        ...
        calc_response = client.post("/api/v1/analytics_v31/metrics/metric-123/calculate", json=calc_request)
