...
class TestCRMCustomerAPI:
    def test_create_crm_customer(self, mock_db, mock_current_user):
        ...
        with (
            patch("app.api.v1.crm_complete_v30.get_db", return_value=mock_db),
            patch(
                "app.api.v1.crm_complete_v30.get_current_user",
    ...
    def test_list_crm_customers(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.get(
                "/api/v1/crm/customers?page=1&per_page=20&lead_status=new"
            )
    ...
    def test_update_crm_customer(self, mock_db, mock_current_user):
        ...
        update_data = CRMCustomerUpdate(
            lead_status="qualified", is_vip=True, lead_score=85
        )
    ...
    def test_add_customer_to_segment(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.post(
                f"/api/v1/crm/customers/{customer_id}/segments/{segment_id}/add"
            )
...
class TestCustomerInteractionAPI:
    def test_create_customer_interaction(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.post(
                "/api/v1/crm/interactions", json=interaction_data.dict()
            )

            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(
                interaction_data, mock_current_user["sub"]
            )
    ...
    def test_get_customer_interactions(self, mock_db, mock_current_user):
        ...
        with (
            ...
            mock_crud.return_value.get_multi_by_customer.return_value = (
                mock_interactions,
                10,
            )

            response = client.get(
                f"/api/v1/crm/customers/{customer_id}/interactions?page=1&per_page=20"
            )
...
class TestSalesOpportunityAPI:
    def test_create_sales_opportunity(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.post(
                "/api/v1/crm/opportunities", json=opportunity_data.dict()
            )

            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(
                opportunity_data, mock_current_user["sub"]
            )
    ...
    def test_list_sales_opportunities(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.get(
                "/api/v1/crm/opportunities?page=1&per_page=20&stage=qualification"
            )
...
class TestSegmentAPI:
    def test_create_customer_segment(self, mock_db, mock_current_user):
        ...
        with (
            ...
            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(
                segment_data, mock_current_user["sub"]
            )
    ...
    def test_calculate_segment_metrics(self, mock_db, mock_current_user):
        ...
        with (
            ...
            assert response.status_code == 200
            mock_crud.return_value.calculate_segment_metrics.assert_called_once_with(
                segment_id
            )
...
class TestMarketingCampaignAPI:
    def test_create_marketing_campaign(self, mock_db, mock_current_user):
        ...
        with (
            ...
            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(
                campaign_data, mock_current_user["sub"]
            )
...
class TestActivityAPI:
    def test_create_opportunity_activity(self, mock_db, mock_current_user):
        ...
        with (
            ...
            response = client.post(
                "/api/v1/crm/activities/opportunities", json=activity_data.dict()
            )

            assert response.status_code == 201
            mock_crud.return_value.create.assert_called_once_with(
                activity_data, mock_current_user["sub"]
            )
    ...
    def test_create_customer_activity(self, mock_db, mock_current_user):
        ...
        activity_data = CustomerActivityCreate(
            ...
            source="google_ads",
            custom_fields={"utm_source": "google", "utm_campaign": "spring_campaign"},
        )
        ...
        with (
            ...
            response = client.post(
                "/api/v1/crm/activities/customers", json=activity_data.dict()
            )
...
class TestAnalyticsAPI:
        ...
        mock_analytics = {
            ...
            "stage_breakdown": {
                "prospecting": {
                    ...
                    "weighted_value": Decimal("3750000"),
                },
                "qualification": {
                    "count": 20,
                    "value": Decimal("10000000"),
                    "weighted_value": Decimal("7500000"),
                },
                "proposal": {
                    "count": 10,
                    "value": Decimal("5000000"),
                    "weighted_value": Decimal("4000000"),
                },
                "negotiation": {
                    "count": 5,
                    "value": Decimal("2500000"),
                    "weighted_value": Decimal("2250000"),
                },
            },
        }
    ...
    def test_get_crm_stats(self, mock_db, mock_current_user):
        ...
        with (
            ...
            mock_db.query.return_value.with_entities.return_value.scalar.return_value = Decimal(
                "50000000"
            )
    ...
    def test_get_crm_analytics(self, mock_db, mock_current_user):
        ...
        with (
            ...
            mock_db.query.return_value.filter.return_value.with_entities.return_value.scalar.return_value = Decimal(
                "5000000"
            )
