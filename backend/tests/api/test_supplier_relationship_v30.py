...
class TestSupplierRelationshipAPI:
    ...
    def test_create_supplier_relationship_success(self, mock_crud_class, sample_relationship_data, sample_relationship_response):
        """サプライヤー関係作成成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.create.return_value = Mock(**sample_relationship_response)

        response = client.post("/supplier-relationships/relationships", json=sample_relationship_data)
        ...
        assert data["relationship_type"] == sample_relationship_data["relationship_type"]
        assert data["partnership_level"] == sample_relationship_data["partnership_level"]

    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_create_supplier_relationship_duplicate_error(self, mock_crud_class, sample_relationship_data):
        """サプライヤー関係作成重複エラーテスト"""
        from app.crud.supplier_relationship_v30 import DuplicateError
        mock_crud = mock_crud_class.return_value
        mock_crud.create.side_effect = DuplicateError("Supplier relationship already exists")
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_get_supplier_relationship_success(self, mock_crud_class, sample_relationship_response):
        """サプライヤー関係詳細取得成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.get_by_id.return_value = Mock(**sample_relationship_response)

        relationship_id = "rel-123"
        response = client.get(f"/supplier-relationships/relationships/{relationship_id}")
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_list_supplier_relationships_success(self, mock_crud_class, sample_relationship_response):
        """サプライヤー関係一覧取得成功テスト"""
        mock_crud = mock_crud_class.return_value
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_list_supplier_relationships_with_filters(self, mock_crud_class, sample_relationship_response):
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_update_supplier_relationship_success(self, mock_crud_class, sample_relationship_response):
        """サプライヤー関係更新成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        response = client.put(f"/supplier-relationships/relationships/{relationship_id}", json=update_data)
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierRelationshipCRUD')
    def test_approve_supplier_relationship_success(self, mock_crud_class, sample_relationship_response):
        """サプライヤー関係承認成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        relationship_id = "rel-123"
        response = client.post(f"/supplier-relationships/relationships/{relationship_id}/approve")
    ...
    def test_schedule_supplier_review_success(self, mock_crud_class):
        ...
        response = client.post(f"/supplier-relationships/relationships/{relationship_id}/schedule-review?review_date={review_date}")
...
class TestSupplierPerformanceReviewAPI:
    ...
    def test_create_performance_review_success(self, mock_crud_class, sample_review_data, sample_review_response):
        """パフォーマンスレビュー作成成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.create.return_value = Mock(**sample_review_response)

        response = client.post("/supplier-relationships/performance-reviews", json=sample_review_data)

        assert response.status_code == 201
        mock_crud.create.assert_called_once()
        
        data = response.json()
        assert data["supplier_relationship_id"] == sample_review_data["supplier_relationship_id"]
        assert data["review_type"] == sample_review_data["review_type"]

    @patch('app.api.v1.supplier_relationship_v30.SupplierPerformanceReviewCRUD')
    def test_get_performance_review_success(self, mock_crud_class, sample_review_response):
        """パフォーマンスレビュー詳細取得成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.get_by_id.return_value = Mock(**sample_review_response)

        review_id = "review-123"
        response = client.get(f"/supplier-relationships/performance-reviews/{review_id}")
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierPerformanceReviewCRUD')
    def test_list_relationship_performance_reviews_success(self, mock_crud_class, sample_review_response):
        ...
        relationship_id = "rel-123"
        response = client.get(f"/supplier-relationships/relationships/{relationship_id}/performance-reviews")
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierPerformanceReviewCRUD')
    def test_update_performance_review_success(self, mock_crud_class, sample_review_response):
        """パフォーマンスレビュー更新成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        review_id = "review-123"
        update_data = {"review_status": "completed", "general_comments": "Review completed"}
        response = client.put(f"/supplier-relationships/performance-reviews/{review_id}", json=update_data)
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierPerformanceReviewCRUD')
    def test_approve_performance_review_success(self, mock_crud_class, sample_review_response):
        """パフォーマンスレビュー承認成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        review_id = "review-123"
        response = client.post(f"/supplier-relationships/performance-reviews/{review_id}/approve")
...
class TestSupplierNegotiationAPI:
    ...
    def sample_negotiation_data(self):
        return {
            ...
            "service_level_agreements": [
                {"metric": "Response time", "target": "24 hours", "penalty": "1% reduction"}
            ],
            "penalty_clauses": [
            ...
            "supplier_representatives": ["John Smith - Procurement Manager", "Jane Doe - Sales Director"]
        }
    ...
    def test_create_supplier_negotiation_success(self, mock_crud_class, sample_negotiation_data, sample_negotiation_response):
        """サプライヤー交渉作成成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.create.return_value = Mock(**sample_negotiation_response)

        response = client.post("/supplier-relationships/negotiations", json=sample_negotiation_data)
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierNegotiationCRUD')
    def test_get_supplier_negotiation_success(self, mock_crud_class, sample_negotiation_response):
        """サプライヤー交渉詳細取得成功テスト"""
        mock_crud = mock_crud_class.return_value
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierNegotiationCRUD')
    def test_list_supplier_negotiations_success(self, mock_crud_class, sample_negotiation_response):
        """サプライヤー交渉一覧取得成功テスト"""
        mock_crud = mock_crud_class.return_value
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierNegotiationCRUD')
    def test_update_supplier_negotiation_success(self, mock_crud_class, sample_negotiation_response):
        """サプライヤー交渉更新成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        response = client.put(f"/supplier-relationships/negotiations/{negotiation_id}", json=update_data)
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierNegotiationCRUD')
    def test_complete_supplier_negotiation_success(self, mock_crud_class, sample_negotiation_response):
        """サプライヤー交渉完了成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        response = client.post(f"/supplier-relationships/negotiations/{negotiation_id}/complete?final_agreement_document={final_document}")
...
class TestSupplierContractAPI:
    ...
    def sample_contract_data(self):
        return {
            ...
            "payment_terms": "Net 30 days",
            "payment_schedule": [
                {"milestone": "Contract signing", "percentage": 20, "due_date": "2024-01-01"}
            ],
            ...
            "compliance_requirements": ["Environmental regulations", "Safety standards"],
            "audit_rights": True,
            "certifications_required": ["ISO 9001", "ISO 14001"],
            "service_level_agreements": [
                {"metric": "On-time delivery", "target": "95%", "measurement": "monthly"}
            ],
            ...
            "insurance_requirements": ["Product liability $10M", "General liability $5M"],
            "force_majeure_clauses": ["Natural disasters", "Government regulations"],
            "termination_conditions": ["Material breach", "Insolvency", "Change of control"],
    ...
    def test_create_supplier_contract_success(self, mock_crud_class, sample_contract_data, sample_contract_response):
        """サプライヤー契約作成成功テスト"""
        mock_crud = mock_crud_class.return_value
        mock_crud.create.return_value = Mock(**sample_contract_response)

        response = client.post("/supplier-relationships/contracts", json=sample_contract_data)
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierContractCRUD')
    def test_get_supplier_contract_success(self, mock_crud_class, sample_contract_response):
        """サプライヤー契約詳細取得成功テスト"""
        mock_crud = mock_crud_class.return_value
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierContractCRUD')
    def test_list_supplier_contracts_success(self, mock_crud_class, sample_contract_response):
        """サプライヤー契約一覧取得成功テスト"""
        mock_crud = mock_crud_class.return_value
    ...
    @patch('app.api.v1.supplier_relationship_v30.SupplierContractCRUD')
    def test_update_supplier_contract_success(self, mock_crud_class, sample_contract_response):
        """サプライヤー契約更新成功テスト"""
        mock_crud = mock_crud_class.return_value
        ...
        response = client.put(f"/supplier-relationships/contracts/{contract_id}", json=update_data)
...
class TestSupplierAnalyticsAPI:
    ...
    def test_get_supplier_performance_analytics_success(self):
        ...
        with patch('app.api.v1.supplier_relationship_v30.SupplierPerformanceReview') as mock_review_model:
            with patch('app.api.v1.supplier_relationship_v30.func') as mock_func:
                ...
                with patch('app.api.v1.supplier_relationship_v30.get_db', return_value=mock_db):
                    response = client.get(f"/supplier-relationships/performance-analytics?date_from={date_from}&date_to={date_to}")
...
class TestSupplierRelationshipValidation:
    ...
    def test_create_relationship_invalid_data(self):
        ...
        response = client.post("/supplier-relationships/relationships", json=invalid_data)
    ...
    def test_create_review_missing_required_fields(self):
        ...
        response = client.post("/supplier-relationships/performance-reviews", json=invalid_data)
    ...
    def test_create_negotiation_invalid_dates(self):
        ...
        response = client.post("/supplier-relationships/negotiations", json=invalid_data)
