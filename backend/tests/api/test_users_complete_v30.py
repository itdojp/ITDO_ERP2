...
from app.schemas.user_complete_v30 import UserCreate, UserResponse
...
class TestUsersCompleteV30:
    ...
    async def test_create_user_success(self, mock_admin_user):
        ...
        with patch('app.api.v1.users_complete_v30.require_admin', return_value=mock_admin_user), \
             patch('app.api.v1.users_complete_v30.get_db') as mock_db, \
    ...
    async def test_create_user_duplicate_email(self, mock_admin_user):
        ...
        with patch('app.api.v1.users_complete_v30.require_admin', return_value=mock_admin_user), \
            ...
            mock_crud_instance = Mock()
            mock_crud.return_value = mock_crud_instance
            mock_crud_instance.create.side_effect = DuplicateError("Email already registered")
    ...
    async def test_list_users_with_pagination(self, mock_user):
        ...
        with patch('app.api.v1.users_complete_v30.get_current_user', return_value=mock_user), \
             patch('app.api.v1.users_complete_v30.get_db') as mock_db, \
             patch('app.crud.user_extended_v30.UserCRUD') as mock_crud:
    ...
    async def test_update_user_unauthorized(self, mock_user):
        ...
        with patch('app.api.v1.users_complete_v30.get_current_user', return_value=other_user):
