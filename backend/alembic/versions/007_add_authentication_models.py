...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('mfa_backup_codes', sa.String(length=500), nullable=True))
    ...
    op.create_table('session_configurations',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('session_timeout_minutes', sa.Integer(), nullable=False, server_default='480'),
        sa.Column('remember_me_duration_days', sa.Integer(), nullable=False, server_default='30'),
        sa.Column('max_concurrent_sessions', sa.Integer(), nullable=False, server_default='5'),
        sa.Column('require_mfa_for_new_device', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_session_configurations_user_id', 'session_configurations', ['user_id'], unique=True)
