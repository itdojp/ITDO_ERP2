...
def upgrade() -> None:
    ...
    op.create_table('permissions',
        ...
        sa.Column('code', sa.String(100), nullable=False, comment='Unique permission code'),
        sa.Column('name', sa.String(200), nullable=False, comment='Permission display name'),
        sa.Column('description', sa.Text(), nullable=True, comment='Permission description'),
        sa.Column('category', sa.String(50), nullable=False, comment='Permission category'),
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true', comment='Whether permission is active'),
        sa.Column('is_system', sa.Boolean(), nullable=False, server_default='false', comment='Whether this is a system permission'),
    ...
    op.create_index('ix_permissions_category_active', 'permissions', ['category', 'is_active'])
    ...
    op.create_table('role_permissions',
        ...
        sa.Column('granted_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='When permission was granted'),
        sa.Column('granted_by', sa.Integer(), nullable=True, comment='User who granted the permission'),
    ...
    op.add_column('user_roles', sa.Column('valid_to', sa.DateTime(timezone=True), nullable=True, comment='When the role validity ends (deprecated, use expires_at)'))
