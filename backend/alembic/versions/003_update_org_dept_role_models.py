...
def upgrade() -> None:
    ...
    op.add_column(
        "departments", sa.Column("headcount_limit", sa.Integer(), nullable=True)
    )
    op.add_column(
        "departments", sa.Column("department_type", sa.String(50), nullable=True)
    )
    op.add_column(
        "departments", sa.Column("cost_center_code", sa.String(50), nullable=True)
    )
    op.add_column(
        "departments",
    ...
    op.create_foreign_key(
        "fk_departments_parent_id", "departments", "departments", ["parent_id"], ["id"]
    )
    op.create_foreign_key(
        "fk_departments_manager_id", "departments", "users", ["manager_id"], ["id"]
    )
    op.create_foreign_key(
        "fk_departments_created_by", "departments", "users", ["created_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_departments_updated_by", "departments", "users", ["updated_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_departments_deleted_by", "departments", "users", ["deleted_by"], ["id"]
    )
    ...
    op.add_column(
        "roles",
        sa.Column("role_type", sa.String(50), server_default="custom", nullable=False),
    )
    op.add_column("roles", sa.Column("parent_id", sa.Integer(), nullable=True))
    op.add_column(
        "roles", sa.Column("permissions", JSON(), server_default="{}", nullable=False)
    )
    op.add_column(
        "roles",
    ...
    op.create_foreign_key(
        "fk_roles_created_by", "roles", "users", ["created_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_roles_updated_by", "roles", "users", ["updated_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_roles_deleted_by", "roles", "users", ["deleted_by"], ["id"]
    )
    ...
    op.add_column(
        "user_roles", sa.Column("approval_status", sa.String(50), nullable=True)
    )
    ...
    op.create_foreign_key(
        "fk_user_roles_approved_by", "user_roles", "users", ["approved_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_user_roles_created_by", "user_roles", "users", ["created_by"], ["id"]
    )
    op.create_foreign_key(
        "fk_user_roles_updated_by", "user_roles", "users", ["updated_by"], ["id"]
    )

    # Add unique constraint and indexes for user_roles
    op.create_unique_constraint(
        "uq_user_role_org_dept",
        "user_roles",
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_organizations_parent_id", "organizations", type_="foreignkey"
    )
