...
def upgrade():
    ...
    try:
        ...
        print(f"✅ Added index: audit_logs.user_id,created_at")
    ...
    try:
        ...
        print(f"✅ Added index: user_activity_logs.user_id,timestamp")
    except Exception as e:
        print(f"⚠️ Index creation failed (may already exist): {e}")
    ...
    try:
        ...
        print(f"✅ Added index: tasks.status,due_date")
    except Exception as e:
        print(f"⚠️ Index creation failed (may already exist): {e}")
    ...
    try:
        ...
        print(f"✅ Added index: expenses.category_id,created_at")
    except Exception as e:
        print(f"⚠️ Index creation failed (may already exist): {e}")
    ...
    try:
        ...
        print(f"✅ Added index: users.email")
    except Exception as e:
        print(f"⚠️ Index creation failed (may already exist): {e}")
    ...
    try:
        ...
        print(f"✅ Added index: organizations.is_active,created_at")
    except Exception as e:
        print(f"⚠️ Index creation failed (may already exist): {e}")
...
def downgrade():
    ...
    try:
        ...
        print(f"✅ Removed index: idx_audit_logs_user_id_created_at")
    except Exception as e:
    ...
    try:
        ...
        print(f"✅ Removed index: idx_user_activity_logs_user_id_timestamp")
    except Exception as e:
        print(f"⚠️ Index removal failed: {e}")
    ...
    try:
        ...
        print(f"✅ Removed index: idx_tasks_status_due_date")
    except Exception as e:
        print(f"⚠️ Index removal failed: {e}")
    ...
    try:
        ...
        print(f"✅ Removed index: idx_expenses_category_id_created_at")
    except Exception as e:
        print(f"⚠️ Index removal failed: {e}")
    ...
    try:
        ...
        print(f"✅ Removed index: idx_users_email")
    except Exception as e:
        print(f"⚠️ Index removal failed: {e}")
    ...
    try:
        ...
        print(f"✅ Removed index: idx_organizations_is_active_created_at")
    except Exception as e:
        print(f"⚠️ Index removal failed: {e}")
