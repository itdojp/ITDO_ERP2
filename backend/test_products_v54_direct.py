...
from app.api.v1.products_v54_simple import (
    router, products_db, categories_db,
    create_category, list_categories, create_product, list_products,
    get_product, update_product, delete_product, get_product_stats,
...
async def test_products_v54():
    ...
    category_data = CategoryCreate(name="Electronics", description="Electronic products")
