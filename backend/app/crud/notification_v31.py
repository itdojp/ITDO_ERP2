...
class NotificationService:
    ...
    async def create_notification(
        ...
        notification = NotificationExtended(
            ...
            primary_channel=notification_data.get("primary_channel", NotificationChannel.IN_APP),
    ...
    async def get_notification_by_id(self, db: Session, notification_id: str) -> Optional[NotificationExtended]:
        ...
        return db.query(NotificationExtended).options(
        ...
        ).filter(NotificationExtended.id == notification_id).first()
    ...
    async def create_notification_template(
        ...
        template = NotificationTemplate(
            ...
            default_priority=template_data.get("default_priority", NotificationPriority.NORMAL),
    ...
    async def create_delivery_record(
        ...
        delivery = NotificationDelivery(
            ...
            recipient_name=delivery_data.get("recipient_name") if delivery_data else None,
            recipient_type=delivery_data.get("recipient_type", "user") if delivery_data else "user",
