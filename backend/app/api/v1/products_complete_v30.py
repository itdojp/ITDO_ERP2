...
from app.schemas.product_complete_v30 import (
    ...
    ProductStatsResponse, BulkPriceUpdateRequest, BulkPriceUpdateResponse,
    ProductPriceHistoryResponse
)
from app.crud.product_extended_v30 import (
    ProductCRUD, ProductCategoryCRUD, SupplierCRUD,
...
async def list_products(
    ...
    for key, value in {
        ...
        "brand": brand, "product_status": product_status, "product_type": product_type,
        "is_sellable": is_sellable, "low_stock": low_stock, "out_of_stock": out_of_stock,
...
@router.get("/products/{product_id}/inventory/movements", response_model=List[InventoryMovementResponse])
...
@router.get("/products/{product_id}/price-history", response_model=List[ProductPriceHistoryResponse])
...
async def list_suppliers(
    ...
    for key, value in {
        ...
        "is_preferred": is_preferred, "supplier_type": supplier_type
    }.items():
        if value is not None:
            filters[key] = value
