...
@router.get(
    "/organizations/{org_id}/hierarchy", response_model=OrganizationHierarchyResponse
)
...
@router.get(
    "/organizations/{org_id}/departments", response_model=List[DepartmentResponse]
)
async def list_departments(
    ...
    departments, total = crud.get_multi(
        skip=skip, limit=per_page, organization_id=org_id, filters=filters
    )
...
@router.post(
    "/organizations/{org_id}/addresses", response_model=AddressResponse, status_code=201
)
...
@router.post(
    "/organizations/{org_id}/contacts", response_model=ContactResponse, status_code=201
)
