...
class PermissionMatrix:
    ...
    def _is_level_lower_or_equal(self, level1: PermissionLevel, level2: PermissionLevel) -> bool:
        """Check if level1 is lower than or equal to level2."""
        return self.PERMISSION_HIERARCHY.index(level1) <= self.PERMISSION_HIERARCHY.index(level2)
    ...
    def get_context_permissions(
        self, 
        level: Union[str, PermissionLevel], 
        context: str
    ) -> Set[str]:
        """
    ...
    def _check_wildcard_permissions(self, permissions: Set[str], permission: str) -> bool:
    ...
    def get_user_effective_level(
        ...
        for user_role in user_roles:
            ...
            if self.PERMISSION_HIERARCHY.index(role_level) > self.PERMISSION_HIERARCHY.index(highest_level):
    ...
    def check_user_permission(
        ...
        effective_level = self.get_user_effective_level(user, organization_id, department_id)
        
        # Check permission
        return self.has_permission(effective_level, permission, context)
    
    def get_all_permissions(self, level: Union[str, PermissionLevel]) -> Dict[str, Set[str]]:
        """
    ...
    def get_permission_differences(
        self, 
        level1: Union[str, PermissionLevel], 
        level2: Union[str, PermissionLevel]
    ) -> Dict[str, Set[str]]:
        """
...
def get_user_permissions(
    ...
    """
    effective_level = permission_matrix.get_user_effective_level(user, organization_id, department_id)
...
def get_permission_level(
    ...
    Returns:
        Permission level
    """
    return permission_matrix.get_user_effective_level(user, organization_id, department_id)