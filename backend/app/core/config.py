...
class Settings(BaseSettings):
    ...
    POSTGRES_PASSWORD: str = Field(default="itdo_password", description="PostgreSQL password")
    ...
    KEYCLOAK_CLIENT_ID: str = Field(default="itdo-erp-client", description="Keycloak client ID")
    KEYCLOAK_CLIENT_SECRET: str = Field(default="", description="Keycloak client secret")

    # セキュリティ設定
    SECRET_KEY: str = Field(default="test-secret-key-for-development-only", description="Secret key for JWT tokens")
    ALGORITHM: str = "HS256"
