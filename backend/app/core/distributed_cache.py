...
class CacheStats:
    ...
    def memory_utilization(self) -> float:
        ...
        return (self.memory_used_mb / self.memory_limit_mb * 100) if self.memory_limit_mb > 0 else 0.0
...
class DistributedCacheManager:
    ...
    def _initialize_default_nodes(self) -> None:
        ...
        redis_nodes = [
            CacheNode(id="redis_1", host="localhost", port=6379, weight=2.0, max_memory_mb=2048),
            CacheNode(id="redis_2", host="localhost", port=6380, weight=2.0, max_memory_mb=2048),
            CacheNode(id="redis_3", host="localhost", port=6381, weight=2.0, max_memory_mb=2048)
        ]
    ...
    async def get(self, key: str) -> Optional[Any]:
        ...
        try:
            ...
            if self.backend in [CacheBackend.HYBRID, CacheBackend.REDIS]:
                nodes = self.consistent_hash.get_nodes_for_replication(key, self.replication_factor)
    ...
    def _record_operation_time(self, start_time: float) -> None:
        ...
        if self.operation_times:
            self.stats.avg_response_time_ms = sum(self.operation_times) / len(self.operation_times)
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "statistics": {
                ...
                "memory_utilization_percentage": round(self.stats.memory_utilization, 2),
            ...
            "nodes": {
                ...
                "healthy_percentage": round((healthy_nodes / len(self.nodes) * 100), 2) if self.nodes else 0
            },
            "configuration": {
