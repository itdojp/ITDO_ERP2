...
class InventoryItemResponse(InventoryItemBase):
    ...
    last_received_date: Optional[datetime] = Field(None, description="Last received date")
...
class StockAdjustmentCreate(BaseModel):
    ...
    inventory_item_id: int = Field(..., description="Inventory item ID")
    new_quantity: Decimal = Field(..., ge=0, description="New quantity after adjustment")
    unit_cost: Optional[Decimal] = Field(None, ge=0, description="Unit cost")
