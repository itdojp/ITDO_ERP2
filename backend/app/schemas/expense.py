...
class ExpenseSummary(BaseModel):
    ...
    # Category breakdown
    by_category: List[dict] = Field(default_factory=list, description="Amount by category")
    by_month: List[dict] = Field(default_factory=list, description="Amount by month")
    by_employee: List[dict] = Field(default_factory=list, description="Amount by employee")
