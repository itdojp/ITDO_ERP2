...
class ProductBase(BaseModel):
    ...
    product_status: str = Field(default="active", regex="^(active|inactive|discontinued)$")
...
class ProductUpdate(BaseModel):
    ...
    # ステータス
    product_status: Optional[str] = Field(None, regex="^(active|inactive|discontinued)$")
...
class ProductImageBase(BaseModel):
    ...
    image_type: str = Field(default="product", regex="^(product|variant|detail|lifestyle)$")
...
class SupplierBase(BaseModel):
    ...
    # サプライヤー情報
    supplier_type: Optional[str] = Field(None, regex="^(manufacturer|distributor|wholesaler)$")
