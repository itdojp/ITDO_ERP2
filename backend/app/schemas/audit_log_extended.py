...
class AuditLogRetentionPolicy(BaseModel):
    ...
    archive_enabled: bool = Field(False, description="Whether to archive before deletion")
...
class AuditLogAlert(BaseModel):
    ...
    threshold: Optional[int] = Field(None, description="Number of events to trigger alert")
