...
class ConfigurationManager:
    ...
    def add_configuration(self, config_item: ConfigurationItem):
    ...
    async def load_configuration(self, config_id: str) -> Dict[str, Any]:
        ...
        try:
            if config_item.source == ConfigurationSource.FILE:
                ...
                raise ValueError(f"Unsupported configuration source: {config_item.source}")
    ...
    async def _load_vault_config(self, config_item: ConfigurationItem) -> Dict[str, Any]:
    ...
    async def watch_configuration(self, config_id: str, callback: Callable):
    ...
    async def _watch_config_changes(self, config_id: str):
...
class InfrastructureProvisioner:
    ...
    def __init__(self, template_engine: TemplateEngine, config_manager: ConfigurationManager):
    ...
    def add_template(self, template: InfrastructureTemplate):
    ...
    async def create_deployment_plan(self, plan_name: str, template_ids: List[str],
                                   target_environment: str, 
    ...
    async def _generate_plan_details(self, plan: DeploymentPlan):
        ...
        for template_id in plan.templates:
            ...
            try:
                ...
                rendered_content = self.template_engine.render_template(
                    ...
                    {**template.variables, **plan.variables}
                )
    ...
    async def _parse_template_resources(self, template: InfrastructureTemplate,
                                      rendered_content: str) -> List[Dict[str, Any]]:
    ...
    async def _provision_template(self, template: InfrastructureTemplate,
    ...
    async def _provision_terraform(self, template: InfrastructureTemplate,
                                 content: str) -> bool:
    ...
    async def _provision_kubernetes(self, template: InfrastructureTemplate,
                                  content: str) -> bool:
    ...
    async def _provision_aws(self, template: InfrastructureTemplate,
                           content: str) -> bool:
    ...
    async def _destroy_template(self, template: InfrastructureTemplate,
                              plan: DeploymentPlan) -> bool:
    ...
    def get_provisioning_status(self) -> Dict[str, Any]:
        ...
        applied_plans = len([
            p for p in self.deployment_plans.values()
...
class DriftDetector:
    ...
    def __init__(self, provisioner: InfrastructureProvisioner):
    ...
    async def _detect_plan_drift(self, plan: DeploymentPlan):
    ...
    async def _check_template_drift(self, template: InfrastructureTemplate,
                                  plan: DeploymentPlan) -> List[DriftDetectionResult]:
        ...
        try:
            ...
            for expected_resource in expected_resources:
                ...
                actual_resource = next(
                    (r for r in actual_resources if r["name"] == resource_id),
                    None
                )
    ...
    async def _get_actual_resource_state(self, template: InfrastructureTemplate,
                                       expected_resources: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    async def _handle_critical_drift(self, plan: DeploymentPlan,
                                   critical_drifts: List[DriftDetectionResult]):
    ...
    def get_drift_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_check": max([r.timestamp for r in self.drift_results]) if self.drift_results else None
        }
...
class ConfigurationIaCSystem:
    ...
    async def start_iac_monitoring(self):
    ...
    async def deploy_infrastructure(self, plan_name: str, template_ids: List[str],
                                  environment: str, variables: Dict[str, Any]) -> str:
        ...
        for config_id, config_item in self.config_manager.configurations.items():
            if config_item.environment == environment:
                try:
                    config_data = await self.config_manager.load_configuration(config_id)
    ...
    async def update_infrastructure(self, plan_id: str, 
    ...
    async def destroy_infrastructure(self, plan_id: str) -> bool:
        ...
        if success:
            logging.info(f"Infrastructure destroyed successfully")
        else:
            logging.error(f"Infrastructure destruction failed")
    ...
    async def stop_iac_monitoring(self):
        """Stop IaC monitoring"""
