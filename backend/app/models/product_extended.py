...
class Product(Base):
    ...
    product_status = Column(String(50), default="active")  # active, inactive, discontinued
    lifecycle_stage = Column(String(50), default="active")  # new, active, mature, declining, discontinued
...
class ProductImage(Base):
    ...
    # 画像分類
    image_type = Column(String(50), default="product")  # product, variant, detail, lifestyle
...
class InventoryMovement(Base):
    ...
    # 移動理由・参照
    reference_type = Column(String(50))  # purchase_order, sale_order, adjustment, transfer
