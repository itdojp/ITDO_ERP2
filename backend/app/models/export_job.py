...
class ExportJob(Base):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"<ExportJob(id={self.id}, entity='{self.entity_type}', "
...
class ImportJob(Base):
    ...
    status: Mapped[ImportStatus] = mapped_column(
        String(30), nullable=False, default=ImportStatus.PENDING
    )
    progress_percentage: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    total_rows: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"<ImportJob(id={self.id}, entity='{self.entity_type}', "
            f"format='{self.source_format}', status='{self.status}')>"
        )
