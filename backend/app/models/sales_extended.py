...
class SalesOrderItem(Base):
    ...
    # ステータス
    item_status = Column(String(50), default="pending")  # pending, reserved, shipped, delivered, cancelled
...
class ShipmentItem(Base):
    ...
    sales_order_item_id = Column(String, ForeignKey('sales_order_items.id'), nullable=False)
    product_id = Column(String, ForeignKey('products.id'), nullable=False)
