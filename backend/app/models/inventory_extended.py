...
class Warehouse(Base):
    ...
    )  # standard, cold_storage, hazardous
...
class InventoryItem(Base):
    ...
    quality_status = Column(
        String(50), default="good"
    )  # good, damaged, expired, quarantine
...
class StockMovement(Base):
    ...
    transaction_type = Column(
        String(50)
    )  # purchase, sale, adjustment, cycle_count, transfer
...
class InventoryReservation(Base):
    ...
    reservation_type = Column(
        String(50), default="sales_order"
    )  # sales_order, transfer, maintenance
