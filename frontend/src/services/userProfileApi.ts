...
export const userProfileApi = {
  ...
  async updateLanguage(language: string): Promise<UserPreferences> {
    const response = await apiClient.patch(
      "/api/v1/users/preferences/me/language",
      {
        language,
      },
    );
  ...
  async updateTimezone(timezone: string): Promise<UserPreferences> {
    const response = await apiClient.patch(
      "/api/v1/users/preferences/me/timezone",
      {
        timezone,
      },
    );
  ...
  async updateTheme(
    ...
    const response = await apiClient.patch(
      "/api/v1/users/preferences/me/theme",
      {
        theme,
      },
    );
  ...
  async checkProfileVisibility(
    ...
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/profile/${userId}`,
    );
    return response.data;
  },
  ...
  async checkEmailVisibility(
    ...
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/email/${userId}`,
    );
    return response.data;
  },

  async checkPhoneVisibility(
    userId: number,
  ): Promise<{ visible: boolean; reason?: string }> {
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/phone/${userId}`,
    );
    return response.data;
  },

  async checkActivityVisibility(
    userId: number,
  ): Promise<{ visible: boolean; reason?: string }> {
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/activity/${userId}`,
    );
    return response.data;
  },

  async checkOnlineStatusVisibility(
    userId: number,
  ): Promise<{ visible: boolean; reason?: string }> {
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/online-status/${userId}`,
    );
    return response.data;
  },
  ...
  async checkDirectMessagePermission(
    ...
    const response = await apiClient.get(
      `/api/v1/users/privacy/check/direct-message/${userId}`,
    );
    return response.data;
  },
  ...
  async getFilteredUserData(userId: number): Promise<Partial<User>> {
    const response = await apiClient.get(
      `/api/v1/users/privacy/filter-user-data/${userId}`,
    );
    return response.data;
  },
  ...
  async checkEmailSearchable(): Promise<{ searchable: boolean }> {
    const response = await apiClient.get(
      "/api/v1/users/privacy/searchable/email",
    );
    return response.data;
  },
  ...
  async checkNameSearchable(): Promise<{ searchable: boolean }> {
    const response = await apiClient.get(
      "/api/v1/users/privacy/searchable/name",
    );
    return response.data;
  },
