      ...
      <div className="border-4 border-dashed border-gray-200 rounded-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Manage your product catalog with comprehensive product information, pricing, and categories.</p>
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Monitor stock levels, warehouse operations, and inventory movements in real-time.</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 mb-4">Track sales orders, customer relationships, and revenue analytics.</p>
