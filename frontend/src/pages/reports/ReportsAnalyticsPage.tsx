  ...
  const mockReports: ReportTemplate[] = [
    {
      ...
      description:
        "Comprehensive monthly financial performance overview with P&L analysis",
      category: "Financial",
      type: "dashboard",
      is_favorite: true,
      is_scheduled: true,
    ...
    },
    {
      ...
      description:
        "Detailed sales metrics, trends, and customer segmentation analysis",
      category: "Sales",
      type: "chart",
      is_favorite: true,
      is_scheduled: false,
    ...
    },
    {
      ...
      description:
        "Product inventory analysis with turnover rates and stock optimization",
      category: "Inventory",
      type: "table",
      is_favorite: false,
      is_scheduled: true,
    ...
    },
    {
      ...
      description:
        "HR metrics including productivity, engagement, and performance indicators",
      category: "HR",
      type: "dashboard",
      is_favorite: false,
      is_scheduled: false,
    ...
    },
    {
      ...
      description:
        "Marketing ROI and customer acquisition cost breakdown by channel",
      category: "Marketing",
      type: "chart",
      is_favorite: true,
      is_scheduled: true,
    ...
    },
    {
      ...
      description:
        "Process efficiency metrics and operational KPIs across departments",
      category: "Operations",
      type: "pivot",
      is_favorite: false,
      is_scheduled: false,
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {reportsData?.metrics.total_reports || 0}
                  </Typography>
          ...
          <Grid item xs={12} md={2}>
            <Card sx={{ bgcolor: "success.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {reportsData?.metrics.active_schedules || 0}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Scheduled
                  </Typography>
          ...
          <Grid item xs={12} md={2}>
            <Card sx={{ bgcolor: "info.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {reportsData?.metrics.reports_this_month || 0}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    This Month
                  </Typography>
          ...
          <Grid item xs={12} md={2}>
            <Card sx={{ bgcolor: "warning.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {reportsData?.metrics.avg_generation_time?.toFixed(1) ||
                      "0.0"}
                    s
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
          ...
          <Grid item xs={12} md={2}>
            <Card sx={{ bgcolor: "error.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {reportsData?.metrics.data_freshness_score?.toFixed(1) ||
                      "0.0"}
                    %
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
              ...
              >
                ...
                <Box>
                  <Typography variant="body2" fontWeight="medium">
                    {reportsData?.metrics.most_popular_category || "N/A"}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Most Popular
                  </Typography>
                ...
                <Grid item xs={12} md={6} lg={4} key={report.id}>
                  ...
                  >
                    <CardHeader
                      ...
                      action={
                        <IconButton
                          onClick={() => handleFavoriteToggle(report.id)}
                        >
                          {report.is_favorite ? (
                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <Typography variant="h5" color="info.main">
                      {biData?.revenue_trends.reduce(
                        (sum, item) => sum + item.growth_rate,
                        0,
                      ) / (biData?.revenue_trends.length || 1) || 0}
                      %
                    </Typography>
                  </Box>
                </Stack>
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    <PieChart>
                      <Pie
                        ...
                        labelLine={false}
                        label={(entry) =>
                          `${entry.segment}: ${formatCurrency(entry.revenue)}`
                        }
                        outerRadius={80}
                        fill="#8884d8"
                        dataKey="revenue"
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={4}>
                    <Box textAlign="center">
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Consistent growth across all quarters with strong Q2
                        performance
                      </Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} md={4}>
                    <Box textAlign="center">
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Lifetime value increased by 15% with improved retention
                        strategies
                      </Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} md={4}>
                    <Box textAlign="center">
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Optimized inventory management resulting in improved
                        cash flow
                      </Typography>
                    </Box>
                  </Grid>
