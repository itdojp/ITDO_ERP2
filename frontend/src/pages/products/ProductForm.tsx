...
export const ProductForm: React.FC = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: ProductFormData) => {
      const response = await apiClient.put(`/api/v1/products-basic/${productId}`, data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['products'] });
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label htmlFor="standard_price" className="block text-sm font-medium text-gray-700 mb-2">
                    Standard Price *
                  </label>
                  ...
                  {errors.standard_price && (
                    <p className="mt-1 text-sm text-red-600">{errors.standard_price.message}</p>
                  )}
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="minimum_stock_level" className="block text-sm font-medium text-gray-700 mb-2">
                    Minimum Stock Level
                  </label>
                  <input
                    type="number"
                  ...
                  {errors.minimum_stock_level && (
                    <p className="mt-1 text-sm text-red-600">{errors.minimum_stock_level.message}</p>
                  )}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="is_purchasable" className="ml-2 block text-sm text-gray-900">
                    Can be purchased
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="is_trackable" className="ml-2 block text-sm text-gray-900">
                    Track inventory
                  </label>
                </div>
              </div>
