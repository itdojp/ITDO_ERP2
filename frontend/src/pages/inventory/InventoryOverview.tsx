  ...
  const { data: recentMovements } = useQuery({
    ...
    queryFn: async (): Promise<RecentMovement[]> => {
      const response = await apiClient.get(
        "/api/v1/inventory/movements/recent?limit=10",
      );
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Real-time inventory dashboard and analytics
          </p>
        </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {statistics.total_items.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
                ...
                {recentMovements.slice(0, 5).map((movement) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div
                        className={`text-sm font-medium ${movement.quantity_change >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                ...
                {alertItems.slice(0, 5).map((alert) => (
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center space-x-3">
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getAlertTypeColor(alert.alert_type)}`}
                        >
