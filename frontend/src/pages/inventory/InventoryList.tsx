...
export const InventoryList: React.FC = () => {
  ...
  const alertItems = filteredInventory.filter(item => item.status === 'low' || item.status === 'out').length;
    ...
    <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow border-l-4 border-green-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{filteredInventory.length}品目</p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow border-l-4 border-yellow-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{alertItems}品目</p>
            </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-6">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">保管場所</label>
            <input
              type="text"
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
          <div className="flex justify-between items-center">
            ...
            <p className="text-sm text-gray-600">{filteredInventory.length}件表示中</p>
          </div>
        </div>
        ...
        {filteredInventory.length === 0 && (
          <div className="text-center py-12">
            <div className="text-gray-500">
              ...
              <p className="text-lg font-medium">該当する在庫が見つかりません</p>
