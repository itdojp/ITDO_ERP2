...
export const InvoiceManagementPage: React.FC = () => {
  ...
  const mockInvoices: Invoice[] = [
    ...
    },
    {
      ...
      notes:
        "Data analytics platform implementation - 50% partial payment received",
    },
  ];
  ...
  const columns: GridColDef[] = useMemo(
    () => [
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => {
          const isOverdue =
            new Date(params.value) < new Date() && params.row.status !== "paid";
          return (
            <Typography
              variant="body2"
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {invoiceData?.summary.total_invoices || 0}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Total Invoices
                  </Typography>
          ...
          <Grid item xs={12} md={2.4}>
            <Card sx={{ bgcolor: "success.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {invoiceData?.summary.paid_count || 0}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Paid Invoices
                  </Typography>
          ...
          <Grid item xs={12} md={2.4}>
            <Card sx={{ bgcolor: "error.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    {invoiceData?.summary.overdue_count || 0}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Overdue
                  </Typography>
          ...
          <Grid item xs={12} md={2.4}>
            <Card sx={{ bgcolor: "info.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    ${invoiceData?.summary.total_amount?.toFixed(0) || "0"}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Total Amount
                  </Typography>
            ...
            <Card sx={{ bgcolor: "warning.50" }}>
              ...
              >
                ...
                <Box>
                  <Typography variant="h6">
                    $
                    {invoiceData?.summary.outstanding_amount?.toFixed(0) || "0"}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Outstanding
                  </Typography>
