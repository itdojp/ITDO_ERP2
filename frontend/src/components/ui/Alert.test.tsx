...
describe("Alert", () => {
  ...
  it("applies custom titleClassName", () => {
    render(
      <Alert title="Title" titleClassName="custom-title">
        Alert message
      </Alert>,
    );
  ...
  it("applies custom closeButtonClassName", () => {
    render(
      <Alert closable closeButtonClassName="custom-close">
        Alert message
      </Alert>,
    );
  ...
  it("handles complex content with JSX", () => {
    ...
    expect(
      screen.getByText("This is a complex alert with multiple elements."),
    ).toBeInTheDocument();
