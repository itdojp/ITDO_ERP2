...
export const FileUpload: React.FC<FileUploadProps> = ({
  ...
  }, [maxFiles, validateFile, errorMessages, onError, compress, onCompress, queueMode, uploadQueue, onQueueChange, onFilesChange, autoUpload, onAutoUpload, onUpload]);
  ...
  if (loading) {
    return (
      <div className={cn('flex items-center justify-center p-8', className)} data-testid="fileupload-loading">
        {loadingComponent || (
