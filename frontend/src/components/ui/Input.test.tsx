...
describe('Input', () => {
  ...
  it('applies variant classes correctly', () => {
    ...
    wrapper = screen.getByRole('textbox').parentElement;
    expect(wrapper).toHaveClass('bg-transparent', 'border-2', 'border-gray-300');
  });
  ...
  it('shows character count when showCount is true', () => {
    render(<Input showCount maxLength={10} value="test" onChange={jest.fn()} />);
...
describe('Input.TextArea', () => {
  ...
  it('shows character count for textarea', () => {
    render(<Input.TextArea showCount maxLength={100} value="test" onChange={jest.fn()} />);
  ...
  it('highlights count in red when over limit for textarea', () => {
    render(<Input.TextArea showCount maxLength={3} value="test" onChange={jest.fn()} />);
...
describe('Input edge cases', () => {
  ...
  it('cleans up debounce timer on unmount', () => {
    const onDebounceChange = jest.fn();
    const { unmount } = render(<Input debounce={100} onDebounceChange={onDebounceChange} />);
