...
describe("Pagination", () => {
  ...
  it("renders ellipsis when there are many pages", () => {
    render(
      <Pagination currentPage={15} totalPages={50} onPageChange={jest.fn()} />,
    );
  ...
  it("applies custom activeButtonClassName", () => {
    render(
      <Pagination {...defaultProps} activeButtonClassName="custom-active" />,
    );
  ...
  it("shows correct page range in info text", () => {
    ...
    expect(
      screen.getByText("Showing 21 to 30 of 95 items"),
    ).toBeInTheDocument();
  });
