...
describe("Switch", () => {
  ...
  it("applies size classes correctly", () => {
    ...
    let switchTrack = screen
      .getByRole("switch")
      .parentElement?.querySelector('[class*="w-8"]');
    expect(switchTrack).toHaveClass("w-8", "h-4");

    rerender(<Switch size="md" />);
    switchTrack = screen
      .getByRole("switch")
      .parentElement?.querySelector('[class*="w-12"]');
    expect(switchTrack).toHaveClass("w-12", "h-6");

    rerender(<Switch size="lg" />);
    switchTrack = screen
      .getByRole("switch")
      .parentElement?.querySelector('[class*="w-16"]');
  ...
  it("applies focus styles correctly", () => {
    ...
    const switchTrack = switchElement.parentElement?.querySelector(
  ...
  it("maintains consistent thumb position animation", () => {
    ...
    const switchElement = screen.getByRole("switch");
    const thumb = switchElement.parentElement?.querySelector(
      '[class*="translate-x"]',
    );
  ...
  it("applies disabled styles correctly", () => {
    ...
    const switchTrack = screen
      .getByRole("switch")
      .parentElement?.querySelector('[class*="opacity-50"]');
