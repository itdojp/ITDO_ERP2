...
describe('Breadcrumb', () => {
  ...
  it('applies underline variant classes', () => {
    ...
    const currentItem = screen.getByText('Laptops');
    expect(currentItem).toHaveClass('text-blue-600', 'border-b-2', 'border-blue-600');
  });
  ...
  it('applies pills variant classes', () => {
    ...
    const currentItem = screen.getByText('Laptops');
    expect(currentItem).toHaveClass('rounded-full', 'bg-blue-100', 'text-blue-700');
  });
  ...
  it('applies custom currentItemClassName', () => {
    render(<Breadcrumb {...defaultProps} currentItemClassName="custom-current" />);
  ...
  it('applies custom separatorClassName', () => {
    render(<Breadcrumb {...defaultProps} separatorClassName="custom-separator" />);
  ...
  it('handles ellipsis position start', () => {
    ...
    render(<Breadcrumb items={manyItems} maxItems={3} truncate={true} ellipsisPosition="start" />);
  ...
  it('handles ellipsis position end', () => {
    ...
    render(<Breadcrumb items={manyItems} maxItems={3} truncate={true} ellipsisPosition="end" />);
