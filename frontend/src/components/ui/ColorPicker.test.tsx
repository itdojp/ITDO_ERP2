...
describe('ColorPicker', () => {
  ...
  it('supports custom trigger component', () => {
    const CustomTrigger = ({ onClick }: { onClick: () => void }) => (
      <button data-testid="custom-trigger" onClick={onClick}>Custom</button>
    );
    
    render(<ColorPicker customTrigger={<CustomTrigger onClick={() => {}} />} />);
  ...
  it('supports color history management', () => {
    ...
    expect(onHistoryChange).toHaveBeenCalledWith(expect.arrayContaining(['#ff0000']));
  });
});