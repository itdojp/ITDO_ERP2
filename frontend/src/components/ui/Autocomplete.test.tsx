...
describe("Autocomplete", () => {
  ...
  it("supports placeholder text", () => {
    render(
      <Autocomplete options={mockOptions} placeholder="Search items..." />,
    );
  ...
  it("supports different sizes", () => {
    ...
    sizes.forEach((size) => {
      const { unmount } = render(
        <Autocomplete options={mockOptions} size={size} />,
      );
  ...
  it("supports different themes", () => {
    ...
    themes.forEach((theme) => {
      const { unmount } = render(
        <Autocomplete options={mockOptions} theme={theme} />,
      );
      const container = screen.getByTestId("autocomplete-container");
  ...
  it("supports custom option rendering", () => {
    ...
    expect(screen.getAllByTestId("custom-option")).toHaveLength(
      mockOptions.length,
    );
  });
  ...
  it("handles focus and blur events", () => {
    ...
    const onBlur = vi.fn();
    render(
      <Autocomplete options={mockOptions} onFocus={onFocus} onBlur={onBlur} />,
    );
  ...
  it("supports custom loading component", () => {
    const LoadingComponent = () => (
      <div data-testid="custom-loading">Searching...</div>
    );
    render(
      <Autocomplete
        options={[]}
  ...
  it("supports custom no results component", () => {
    const NoResultsComponent = () => (
      <div data-testid="custom-no-results">No matches found</div>
    );
    render(
      <Autocomplete
        options={mockOptions}
  ...
  it("supports creation of new options", () => {
    ...
    render(
      <Autocomplete options={mockOptions} allowCreate onCreate={onCreate} />,
    );
  ...
  it("supports custom styling", () => {
    render(
      <Autocomplete options={mockOptions} className="custom-autocomplete" />,
    );
