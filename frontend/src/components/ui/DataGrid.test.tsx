...
describe('DataGrid', () => {
  const mockData: TestRowData[] = [
    { id: 1, name: 'John Doe', email: 'john@example.com', age: 30, status: 'active', role: 'admin' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', age: 25, status: 'inactive', role: 'user' },
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', age: 35, status: 'active', role: 'editor' },
    { id: 4, name: 'Alice Brown', email: 'alice@example.com', age: 28, status: 'active', role: 'user' },
    { id: 5, name: 'Charlie Wilson', email: 'charlie@example.com', age: 32, status: 'inactive', role: 'admin' }
  ];
  ...
  it('supports column sorting', () => {
    const onSort = vi.fn();
    render(<DataGrid data={mockData} columns={mockColumns} onSort={onSort} sortable />);
  ...
  it('supports column filtering', () => {
    ...
    const filterInput = screen.getByTestId('global-filter-input').querySelector('input');
  ...
  it('supports custom empty state', () => {
    ...
    render(<DataGrid data={[]} columns={mockColumns} emptyState={customEmpty} />);
  ...
  it('supports different sizes', () => {
    ...
    sizes.forEach(size => {
      const { unmount } = render(<DataGrid data={mockData} columns={mockColumns} size={size} />);
  ...
  it('supports different variants', () => {
    ...
    variants.forEach(variant => {
      const { unmount } = render(<DataGrid data={mockData} columns={mockColumns} variant={variant} />);
      const container = screen.getByTestId('datagrid-container');
  ...
  it('supports toolbar actions', () => {
    ...
    render(<DataGrid data={mockData} columns={mockColumns} toolbar={toolbar} />);
