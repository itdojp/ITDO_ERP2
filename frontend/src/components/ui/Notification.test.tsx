...
describe('Notification', () => {
  ...
  it('shows default icons for different types', () => {
    ...
    typeIcons.forEach(({ type, expectedClass }) => {
      const { unmount } = render(<Notification message="Test" type={type} showDefaultIcon />);
  ...
  it('supports different positions', () => {
    ...
    positions.forEach(position => {
      const { unmount } = render(<Notification message="Test" position={position} />);
      const container = screen.getByTestId('notification-container');
  ...
  it('pauses auto close on hover', async () => {
    const onClose = vi.fn();
    render(<Notification message="Test" duration={1000} pauseOnHover onClose={onClose} />);
  ...
  it('shows multiple lines for long messages', () => {
    const longMessage = 'This is a very long notification message that should wrap to multiple lines when displayed';
  ...
  it('supports priority levels', () => {
    ...
    priorities.forEach(priority => {
      const { unmount } = render(<Notification message="Test" priority={priority} />);
      const container = screen.getByTestId('notification-container');
  ...
  it('supports custom timestamp format', () => {
    ...
    render(<Notification message="Test" showTimestamp timestamp={customTimestamp} />);
  ...
  it('handles dismiss on click outside', () => {
    const onClose = vi.fn();
    render(<Notification message="Test" dismissOnClickOutside onClose={onClose} />);
  ...
  it('supports persistent notifications', () => {
    const onClose = vi.fn();
    render(<Notification message="Test" persistent duration={1000} onClose={onClose} />);
  ...
  it('supports custom data attributes', () => {
    render(<Notification message="Test" data-category="system" data-id="notif-1" />);
  ...
  it('handles visibility state changes', () => {
    ...
    let container = screen.getByTestId('notification-container');
  ...
  it('supports sound notifications', () => {
    ...
    render(<Notification message="Test" playSound soundUrl="/notification.mp3" />);
