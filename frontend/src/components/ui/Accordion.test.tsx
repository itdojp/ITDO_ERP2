...
describe('Accordion', () => {
  ...
  it('expands default items when specified', () => {
    render(<Accordion {...defaultProps} defaultExpandedItems={['item1', 'item2']} />);
  ...
  it('does not collapse item when collapsible is false', () => {
    render(<Accordion {...defaultProps} collapsible={false} defaultExpandedItems={['item1']} />);
  ...
  it('applies filled variant classes', () => {
    ...
    const firstItem = screen.getByText('Item 1').closest('div');
    expect(firstItem).toHaveClass('bg-gray-50', 'border', 'border-gray-200', 'rounded-lg');
  });
  ...
  it('applies custom contentClassName', () => {
    render(<Accordion {...defaultProps} contentClassName="custom-content" defaultExpandedItems={['item1']} />);
  ...
  it('sets proper ARIA attributes', () => {
    ...
    expect(content).toHaveAttribute('aria-labelledby', 'accordion-header-item1');
