...
describe("DataTable", () => {
  ...
  it("applies bordered style", () => {
    render(
      <DataTable columns={mockColumns} dataSource={mockData} bordered={true} />,
    );
  ...
  it("applies striped rows", () => {
    render(
      <DataTable columns={mockColumns} dataSource={mockData} striped={true} />,
    );
  ...
  it("handles expandable rows", () => {
    ...
    expect(
      screen.getByText("Expanded content for John Doe"),
    ).toBeInTheDocument();
  });
  ...
  it("handles row click events", () => {
    ...
    render(
      <DataTable columns={mockColumns} dataSource={mockData} onRow={onRow} />,
    );
  ...
  it("applies scroll styles", () => {
    ...
    render(
      <DataTable columns={mockColumns} dataSource={mockData} scroll={scroll} />,
    );
  ...
  it("sorts data correctly", () => {
    ...
    const nameColumns = screen
      .getAllByRole("cell")
      .filter((cell) =>
        ["Bob Johnson", "Jane Smith", "John Doe"].includes(
          cell.textContent || "",
        ),
      );
  ...
  it("displays sort indicators", () => {
    ...
    expect(
      emailHeader.parentElement?.querySelector("svg"),
