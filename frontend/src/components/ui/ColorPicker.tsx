...
export const ColorPicker: React.FC<ColorPickerProps> = ({
  ...
  const [internalValue, setInternalValue] = useState<string | null>(value || defaultValue || null);
  ...
  const handleColorSelect = (color: string) => {
    ...
    // Add to history
    if (onHistoryChange) {
      const newHistory = [color, ...recentColors.filter(c => c !== color)].slice(0, 10);
  ...
  const renderPalette = () => {
    const paletteElement = (
      ...
      >
        ...
        <div className="mb-4">
          ...
          {mode === 'hsl' && (
            <div className="grid grid-cols-3 gap-2">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">S</label>
                <input
                  type="number"
                  min="0"
                  max="100"
        ...
        {showAlpha && (
          <div className="mb-4">
            <label className="block text-xs font-medium text-gray-700 mb-1">Alpha</label>
            <input
              type="range"
              min="0"
              max="1"
            ...
            {palette.map((color, index) => (
              <button
                ...
                className={cn(
                  ...
                  internalValue === color ? 'border-gray-800' : 'border-gray-300'
                )}
        ...
        {showGradients && (
          <div className="mt-4" data-testid="colorpicker-gradients">
            <h4 className="text-xs font-medium text-gray-700 mb-2">Gradients</h4>
