...
describe('Radio', () => {
  ...
  it('renders as controlled component', () => {
    const onChange = vi.fn();
    const { rerender } = render(<Radio label="Test" value="test" checked={false} onChange={onChange} />);
    
    let radio = screen.getByRole('radio');
    expect(radio).not.toBeChecked();
    
    rerender(<Radio label="Test" value="test" checked={true} onChange={onChange} />);
  ...
  it('applies different variants', () => {
    const { rerender } = render(<Radio label="Primary" value="1" variant="primary" />);
    let radio = screen.getByRole('radio');
  ...
  it('renders with custom background', () => {
    const { container } = render(<Radio label="Custom BG" value="custom" background="bg-gray-100" />);
  ...
  it('handles focus and blur events', () => {
    const onFocus = vi.fn();
    const onBlur = vi.fn();
    render(<Radio label="Test" value="test" onFocus={onFocus} onBlur={onBlur} />);
  ...
  it('handles group value changes', () => {
    const onChange = vi.fn();
    render(
      <Radio.Group label="Choose option" value="1" onChange={onChange} name="test">
        <Radio label="Option 1" value="1" />
        <Radio label="Option 2" value="2" />
      </Radio.Group>
    );
  ...
  it('handles group validation', () => {
    render(
      <Radio.Group label="Choose option" error="Please select an option" name="test">
        <Radio label="Option 1" value="1" />
        <Radio label="Option 2" value="2" />
      </Radio.Group>
    );
  ...
  it('handles animation on state change', () => {
    const { rerender } = render(<Radio label="Test" value="test" checked={false} animate />);
  ...
  it('renders with label position variations', () => {
    const { rerender, container } = render(<Radio label="Test" value="test" labelPosition="right" />);
  ...
  it('renders with card-style layout', () => {
    const { container } = render(<Radio label="Card Style" value="card" card />);
