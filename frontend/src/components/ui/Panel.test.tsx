...
describe("Panel", () => {
  ...
  it("supports different variants", () => {
    ...
    variants.forEach((variant) => {
      const { unmount } = render(
        <Panel title="Test" variant={variant}>
          Content
        </Panel>,
      );
      const container = screen.getByTestId("panel-container");
  ...
  it("handles action clicks", () => {
    ...
    const actions = [{ id: "edit", label: "Edit", onClick: editAction }];
  ...
  it("handles tab switching", () => {
    ...
    render(<Panel title="Panel with Tabs" tabs={tabs} />);
