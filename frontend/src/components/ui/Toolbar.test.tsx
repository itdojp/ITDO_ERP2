...
describe('Toolbar', () => {
  ...
  it('supports different orientations', () => {
    ...
    orientations.forEach(orientation => {
      const { unmount } = render(<Toolbar tools={mockTools} orientation={orientation} />);
  ...
  it('supports disabled tools', () => {
    const toolsWithDisabled = [
      { id: 'save', label: 'Save', icon: '💾', onClick: vi.fn(), disabled: true },
      { id: 'copy', label: 'Copy', icon: '📋', onClick: vi.fn() }
    ];
  ...
  it('supports tool groups with separators', () => {
    const groupedTools = [
      { id: 'save', label: 'Save', icon: '💾', onClick: vi.fn(), group: 'file' },
      { id: 'copy', label: 'Copy', icon: '📋', onClick: vi.fn(), group: 'edit' },
      { id: 'paste', label: 'Paste', icon: '📄', onClick: vi.fn(), group: 'edit' }
    ];
  ...
  it('supports different positions', () => {
    ...
    positions.forEach(position => {
      const { unmount } = render(<Toolbar tools={mockTools} position={position} />);
      const container = screen.getByTestId('toolbar-container');
  ...
  it('supports different button variants', () => {
    ...
    variants.forEach(variant => {
      const { unmount } = render(<Toolbar tools={mockTools} variant={variant} />);
      const container = screen.getByTestId('toolbar-container');
  ...
  it('handles toolbar customization', () => {
    ...
    render(<Toolbar tools={mockTools} customizable onCustomize={onCustomize} />);
  ...
  it('supports custom data attributes', () => {
    render(<Toolbar tools={mockTools} data-category="editor" data-id="main-toolbar" />);
