...
describe('Image', () => {
  ...
  it('supports different sizes', () => {
    ...
    sizes.forEach(size => {
      const { unmount } = render(<Image src="/test.jpg" alt="Test" size={size} />);
      const container = screen.getByTestId('image-container');
  ...
  it('supports different object fit modes', () => {
    ...
    objectFits.forEach(objectFit => {
      const { unmount } = render(<Image src="/test.jpg" alt="Test" objectFit={objectFit} />);
      const img = screen.getByRole('img');
  ...
  it('supports rounded corners', () => {
    ...
    radiuses.forEach(radius => {
      const { unmount } = render(<Image src="/test.jpg" alt="Test" radius={radius} />);
      const img = screen.getByRole('img');
      expect(img).toBeInTheDocument();
      unmount();
    });
  ...
  it('supports border styles', () => {
    render(<Image src="/test.jpg" alt="Test" border={{ width: 2, color: 'blue' }} />);
    const img = screen.getByRole('img');
  ...
  it('supports placeholder while loading', async () => {
    render(<Image src="/test.jpg" alt="Test" placeholder="/placeholder.jpg" lazy />);
  ...
  it('supports sizes attribute for responsive images', () => {
    render(<Image src="/test.jpg" alt="Test" sizes="(max-width: 768px) 100vw, 50vw" />);
  ...
  it('supports custom loading component', () => {
    ...
    render(<Image src="/test.jpg" alt="Test" loadingComponent={<CustomLoader />} />);
  ...
  it('supports custom error component', async () => {
    ...
    render(<Image src="/invalid.jpg" alt="Test" errorComponent={<CustomError />} />);
  ...
  it('supports WebP format with fallback', () => {
    ...
    const picture = screen.getByTestId('image-container').querySelector('picture');
    expect(picture).toBeInTheDocument();
  });

  it('supports custom data attributes', () => {
    render(<Image src="/test.jpg" alt="Test" data-category="product" data-id="123" />);
