...
describe("Card", () => {
  ...
  it("applies hover effects when clickable is true", () => {
    render(
      <Card clickable onClick={jest.fn()}>
        Clickable card
      </Card>,
    );
  ...
  it("renders image at top position", () => {
    render(
      <Card image="/test.jpg" imageAlt="Test image" imagePosition="top">
        Card content
      </Card>,
    );
  ...
  it("renders image at bottom position", () => {
    render(
      <Card image="/test.jpg" imageAlt="Test image" imagePosition="bottom">
        Card content
      </Card>,
    );
    const image = screen.getByAltText("Test image");
  ...
  it("renders image at left position", () => {
    render(
      <Card image="/test.jpg" imageAlt="Test image" imagePosition="left">
        Card content
      </Card>,
    );
    const image = screen.getByAltText("Test image");
  ...
  it("renders image at right position", () => {
    render(
      <Card image="/test.jpg" imageAlt="Test image" imagePosition="right">
        Card content
      </Card>,
    );
    const image = screen.getByAltText("Test image");
  ...
  it("renders custom React node as image", () => {
    render(
      <Card image={<div data-testid="custom-image">Custom Image</div>}>
        Card content
      </Card>,
    );
  ...
  it("applies custom imageClassName", () => {
    render(
      <Card image="/test.jpg" imageClassName="custom-image">
        Card content
      </Card>,
    );
  ...
  it("applies custom titleClassName", () => {
    render(
      <Card title="Title" titleClassName="custom-title">
        Card content
      </Card>,
    );
  ...
  it("applies custom subtitleClassName", () => {
    render(
      <Card subtitle="Subtitle" subtitleClassName="custom-subtitle">
        Card content
      </Card>,
    );
