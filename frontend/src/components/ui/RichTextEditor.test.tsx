...
describe('RichTextEditor', () => {
  ...
  it('supports placeholder text', () => {
    ...
    const editor = screen.getByTestId('richtexteditor-content');
    expect(editor).toHaveAttribute('data-placeholder', 'Enter your text here...');
  });
  ...
  it('supports auto-save functionality', async () => {
    ...
    render(<RichTextEditor autoSave onAutoSave={onAutoSave} autoSaveInterval={100} />);
  ...
  it('supports custom loading component', () => {
    const LoadingComponent = () => <div data-testid="custom-loading">Loading editor...</div>;
  ...
  it('supports helper text', () => {
    render(<RichTextEditor helperText="Format your content using the toolbar above" />);
    
    expect(screen.getByText('Format your content using the toolbar above')).toBeInTheDocument();
  });

  it('supports custom data attributes', () => {
    render(<RichTextEditor data-category="content-editor" data-id="main-editor" />);
