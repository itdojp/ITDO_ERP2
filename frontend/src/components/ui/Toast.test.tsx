...
describe("Toast", () => {
  ...
  it("shows action button when provided", () => {
    ...
    render(
      <Toast message="Test" action={{ label: "Undo", onClick: onAction }} />,
    );
  ...
  it("shows default icons for different types", () => {
    ...
    typeIcons.forEach(({ type, expectedClass }) => {
      const { unmount } = render(
        <Toast message="Test" type={type} showDefaultIcon />,
      );
  ...
  it("pauses auto close on hover", async () => {
    const onClose = vi.fn();
    render(
      <Toast message="Test" duration={1000} pauseOnHover onClose={onClose} />,
    );
  ...
  it("shows multiple lines for long messages", () => {
    const longMessage =
      "This is a very long toast message that should wrap to multiple lines when displayed";
  ...
  it("supports persistent toasts", () => {
    const onClose = vi.fn();
    render(
      <Toast message="Test" persistent duration={1000} onClose={onClose} />,
    );
  ...
  it("supports accessibility labels", () => {
    render(<Toast message="Test" ariaLabel="System toast" ariaLive="polite" />);
  ...
  it("supports different animation types", () => {
    ...
    animations.forEach((animation) => {
      const { unmount } = render(
        <Toast message="Test" animationType={animation} />,
      );
      const container = screen.getByTestId("toast-container");
  ...
  it("supports toast with image", () => {
    render(
      <Toast message="Test" image="/test-image.jpg" imageAlt="Test image" />,
    );
