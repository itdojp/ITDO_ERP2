...
const BadgeComponent = forwardRef<HTMLSpanElement, BadgeProps>(({
  ...
  const getVariantClasses = () => {
    ...
    const variantMap = {
      primary: outlined ? 'border-blue-500 text-blue-500 bg-transparent' : 'bg-blue-500 text-white',
      secondary: outlined ? 'border-gray-500 text-gray-500 bg-transparent' : 'bg-gray-500 text-white',
      success: outlined ? 'border-green-500 text-green-500 bg-transparent' : 'bg-green-500 text-white',
      warning: outlined ? 'border-yellow-500 text-yellow-500 bg-transparent' : 'bg-yellow-500 text-white',
      danger: outlined ? 'border-red-500 text-red-500 bg-transparent' : 'bg-red-500 text-white',
      info: outlined ? 'border-cyan-500 text-cyan-500 bg-transparent' : 'bg-cyan-500 text-white'
    };
  ...
  const getRibbonClasses = () => {
    ...
    const ribbonMap = {
      'top-left': 'absolute top-0 left-0 transform -rotate-45 -translate-x-4 -translate-y-1',
      'top-right': 'absolute top-0 right-0 transform rotate-45 translate-x-4 -translate-y-1',
      'bottom-left': 'absolute bottom-0 left-0 transform rotate-45 -translate-x-4 translate-y-1',
      'bottom-right': 'absolute bottom-0 right-0 transform -rotate-45 translate-x-4 translate-y-1'
    };
