...
describe('Checkbox', () => {
  ...
  it('renders as controlled component', () => {
    const onChange = vi.fn();
    const { rerender } = render(<Checkbox label="Test" checked={false} onChange={onChange} />);
  ...
  it('renders with custom background', () => {
    const { container } = render(<Checkbox label="Custom BG" background="bg-gray-100" />);
  ...
  it('handles group validation', () => {
    render(
      <Checkbox.Group label="Choose options" error="Please select at least one option">
        <Checkbox label="Option 1" value="1" />
        <Checkbox label="Option 2" value="2" />
      </Checkbox.Group>
    );
  ...
  it('handles animation on state change', () => {
    const { rerender } = render(<Checkbox label="Test" checked={false} animate />);
  ...
  it('renders with label position variations', () => {
    const { rerender, container } = render(<Checkbox label="Test" labelPosition="right" />);
