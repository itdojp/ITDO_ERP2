...
describe('Progress', () => {
  ...
  it('uses custom text formatter', () => {
    const formatter = (value: number, max: number) => `${value} of ${max} items`;
  ...
  it('applies custom className', () => {
    ...
    const container = screen.getByRole('progressbar').closest('.custom-progress');
  ...
  it('displays label and description', () => {
    render(<Progress value={50} label="Upload Progress" description="Uploading files..." />);
  ...
  it('handles multi-segment progress', () => {
    ...
    const progressContainer = screen.getByText('0%').parentElement?.parentElement?.parentElement;
    const segmentElements = progressContainer?.querySelectorAll('[class*="bg-red-500"], [class*="bg-yellow-500"], [class*="bg-green-500"]');
  ...
  it('handles accessibility attributes', () => {
    ...
    expect(progressBar).toHaveAttribute('aria-describedby', 'upload-description');
  });
  ...
  it('shows custom icons', () => {
    ...
    render(<Progress value={100} icon={<CheckIcon />} label="Upload Complete" />);
  ...
  it('handles onComplete callback', () => {
    ...
    const { rerender } = render(<Progress value={99} onComplete={onComplete} />);
