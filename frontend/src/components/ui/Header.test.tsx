...
describe("Header", () => {
  ...
  it("supports custom search placeholder", () => {
    render(
      <Header title="Test" showSearch searchPlaceholder="Find something..." />,
    );
  ...
  it("handles notification click", () => {
    ...
    render(
      <Header showNotifications onNotificationClick={onNotificationClick} />,
    );
  ...
  it("renders custom actions", () => {
    const actions = <button data-testid="custom-action">Custom Button</button>;
  ...
  it("supports custom loading component", () => {
    const LoadingComponent = () => (
      <div data-testid="custom-loading">Loading header...</div>
    );
    render(
      <Header title="Test" loading loadingComponent={<LoadingComponent />} />,
    );
  ...
  it("supports custom data attributes", () => {
    render(
      <Header title="Test" data-category="navigation" data-id="main-header" />,
    );
