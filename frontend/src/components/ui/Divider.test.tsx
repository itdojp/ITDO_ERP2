...
describe("Divider", () => {
  ...
  it("supports different text alignments", () => {
    ...
    alignments.forEach((align) => {
      const { unmount } = render(
        <Divider textAlign={align}>Aligned Text</Divider>,
      );
  ...
  it("renders with custom content element", () => {
    const customContent = (
      <div data-testid="custom-content">Custom Element</div>
    );
  ...
  it("handles very long text content", () => {
    const longText =
      "This is a very long text content that should be handled properly by the divider component";
