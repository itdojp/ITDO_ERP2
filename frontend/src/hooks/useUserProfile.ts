...
export const USER_PROFILE_KEYS = {
  ...
  profile: (userId: number) =>
    [...USER_PROFILE_KEYS.all, "profile", userId] as const,
  ...
  users: (params: UserSearchParams) =>
    [...USER_PROFILE_KEYS.all, "users", params] as const,
...
export const useUpdatePreferences = () => {
  ...
  return useMutation({
    mutationFn: (data: UserPreferencesUpdate) =>
      userProfileApi.updatePreferences(data),
    onSuccess: (updatedPreferences) => {
      queryClient.setQueryData(
        USER_PROFILE_KEYS.preferences(),
        updatedPreferences,
      );
    },
  });
...
export const useCreatePreferences = () => {
  ...
  return useMutation({
    mutationFn: (data: UserPreferencesUpdate) =>
      userProfileApi.createPreferences(data),
...
export const useUpdateTheme = () => {
  ...
  return useMutation({
    mutationFn: (theme: "light" | "dark" | "auto") =>
      userProfileApi.updateTheme(theme),
    onSuccess: (updatedPreferences) => {
      queryClient.setQueryData(
        USER_PROFILE_KEYS.preferences(),
        updatedPreferences,
...
export const useUpdatePrivacySettings = () => {
  ...
  return useMutation({
    mutationFn: (data: UserPrivacyUpdate) =>
      userProfileApi.updatePrivacySettings(data),
...
export const useCreatePrivacySettings = () => {
  ...
  return useMutation({
    mutationFn: (data: UserPrivacyUpdate) =>
      userProfileApi.createPrivacySettings(data),
